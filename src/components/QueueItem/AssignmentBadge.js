...
export const AssignmentBadge = ({ queueItem, toggle }) =>
  <div className="assignment">
    <span className="assignment-badge" onClick={toggle} role="button" tabIndex={0}>
    ...
    <SVGInline svg={chevronRightIcon} className="icon" onClick={toggle} role="button" tabIndex={0} />
  </div>;
